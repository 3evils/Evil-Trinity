...
define('OCELOT_CONF', '/var/www/html/ocelot.conf');
//==charset
...
$INSTALLER09['cookie_domain'] = '.fataltracker.cc'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
//== Memcache expires
