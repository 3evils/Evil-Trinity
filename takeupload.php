...
if ($imdb_id_new != 0) {
    $omdbapi_key = '60ac17f0'; //Change me to your omdbapi key get @ https://www.omdbapi.com/apikey.aspx
    $omdbkey = "omdb_takup_" . $imdb_id_new;
    if (($omdb = $mc1->get_value($omdbkey)) === false) {
        //==auto imdb rewritten putyn 28/06/2011
        $imdb = '';
        $omdb['Title'] = $omdb['Orig_title'] = $omdb['Year'] = $omdb['Actors'] = $omdb['Rating'] = $omdb['Votes'] = $omdb['Genre'] = $omdb['Runtime'] = $omdb['Country'] = $omdb['Lanuage'] = $omdb['Director'] = $omdb['Producer'] = $omdb['Writer'] = $omdb['Compose'] = $omdb['Plotoutline'] = $omdb['Plot'] = $omdb['Trailers'] = $omdb['Comment'] = "";
